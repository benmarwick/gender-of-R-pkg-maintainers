...
Here is a quick look at the gender ratios of R package maintainers, and how that has changed over time, and how it compares to the R Foundation membership. I started this in June,  motivated by the "Conversation about Râs Gender Gap: The useR! her Panel" at the UseR meeting (http://user2014.stat.ucla.edu/). A recent discussion amongst Jennifer Bryan, Hadley Wickham, and Erin LeDell on twitter where it was noted that only one contributor to R core is a woman, further prompted me to pursue it (https://twitter.com/JennyBryan/status/544970521348034561).
...
Of all the CRAN packages in this dataset, `r props$female_prop * 100`% are maintained by women. This is consistant with the finding of 14% by the "Conversation about Râs Gender Gap: The useR! her Panel" at the 2014 UseR meeting. Now let's see how that has changed over time.
...
And the proportion of R Foundation members that are female is `r prop_female`. Given this underrepresentation, it might be a good idea to vote in Karline Soetaert, Hana Sevcikova and one other active and prominent female R developer as ordinary members of the R Foundation, maybe Bettina GrÃ¼n, who is currently one of the editors of the R Journal. 
